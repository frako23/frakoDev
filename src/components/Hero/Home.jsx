      ...
      <section className="hero" id="home">
        <div className="container f_flex top">
          <div className="left top">
            ...
            <p>
              I am a full stack developer with more than 13 years of experience
              in marketing and sales who decided to make a 180 degree change in
              his professional life to pursue his passion for working in
              technology.
            </p>
            ...
            <div className="hero_btn d_flex">
              <div className="col_1">
                ...
                <div className="button">
                  ...
                  <a href="https://twitter.com/frakoDev">
                    <button className="btn_brands">
